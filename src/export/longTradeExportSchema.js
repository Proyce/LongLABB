...
export const LONG_TRADE_FORENSIC_EXPORT_COLUMNS = [
  ...
  col("realizedHoldMs",     t => t?.closedAt && t?.entryTime ? t.closedAt - t.entryTime : null),
  col("configuredMaxHoldMs", get("configuredMaxHoldMs")),
  col("holdMs",             t => t?.closedAt && t?.entryTime ? t.closedAt - t.entryTime : null),
  col("mae",                get("mae")),
  col("mfe",                get("mfe")),
